  ...
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ...
      : ((global =
        ...
        (global.polygonClipping = factory()));
})(this, function () {
  "use strict";
    ...
    isInResult() {
      ...
      switch (operation.type) {
        ...
        case "difference": {
          ...
          this._isInResult =
            isJustSubject(mpsBefore) !== isJustSubject(mpsAfter);
          break;
        }
        default:
          throw new Error(
            `Unrecognized operation type found ${operation.type}`,
          );
      }
  ...
  class Operation {
    run(type, geom, moreGeoms) {
      ...
      while (node) {
        ...
        if (
          sweepLine.segments.length > POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS
        ) {
          // prevents an infinite loop, an otherwise common manifestation of bugs
          throw new Error(
            "Infinite loop when passing sweep line over endpoints " +
  ...
  const union = function (geom) {
    for (
      var _len = arguments.length,
        moreGeoms = new Array(_len > 1 ? _len - 1 : 0),
        _key = 1;
      _key < _len;
      _key++
    ) {
  ...
  const intersection = function (geom) {
    for (
      var _len2 = arguments.length,
        moreGeoms = new Array(_len2 > 1 ? _len2 - 1 : 0),
        _key2 = 1;
      _key2 < _len2;
      _key2++
    ) {
  ...
  const xor = function (geom) {
    for (
      var _len3 = arguments.length,
        moreGeoms = new Array(_len3 > 1 ? _len3 - 1 : 0),
        _key3 = 1;
      _key3 < _len3;
      _key3++
    ) {
  ...
  const difference = function (subjectGeom) {
    for (
      var _len4 = arguments.length,
        clippingGeoms = new Array(_len4 > 1 ? _len4 - 1 : 0),
        _key4 = 1;
      _key4 < _len4;
      _key4++
    ) {
