 ...
 * @license MIT
 *
 * BUILT: Tue Jun 18 2024 16:11:23 GMT+0200 (Central European Summer Time)
 */
var SVG = (function () {
  "use strict";
  const t = {},
    e = [];
  function n(e, i) {
    if (Array.isArray(e)) for (const t of e) n(t, i);
    else if ("object" != typeof e)
      (r(Object.getOwnPropertyNames(i)), (t[e] = Object.assign(t[e] || {}, i)));
    else for (const t in e) n(t, e[t]);
  }
  function i(e) {
    return t[e] || {};
  }
  ...
  function c(t, e) {
    ...
    const s = "string" == typeof i,
      o = "string" == typeof r;
    if (s || o) {
      const { height: t, width: n, x: h, y: u } = e.bbox();
      (s &&
        (i = i.includes("left") ? h : i.includes("right") ? h + n : h + n / 2),
        o &&
          (r = r.includes("top")
            ? u
            : r.includes("bottom")
  ...
  const f = new Set(["desc", "metadata", "title"]),
    d = (t) => f.has(t.nodeName),
    m = (t, e, n = {}) => {
      const i = { ...e };
      for (const t in i) i[t].valueOf() === n[t] && delete i[t];
      Object.keys(i).length
        ? t.node.setAttribute("data-svgjs", JSON.stringify(i))
  ...
  var x = { __proto__: null, html: w, svg: y, xlink: _, xmlns: g };
  const b = {
    window: "undefined" == typeof window ? null : window,
    document: "undefined" == typeof document ? null : document,
  };
  function v(t = null, e = null) {
    ((b.window = t), (b.document = e));
  }
  const M = {};
  function O() {
    ((M.window = b.window), (M.document = b.document));
  }
  function k() {
    ((b.window = M.window), (b.document = M.document));
  }
  class T {}
  const C = {},
    N = "___SYMBOL___ROOT___";
  function S(t, e = y) {
    return b.document.createElementNS(e, t);
  }
  function E(t, e = !1) {
    if (t instanceof T) return t;
    if ("object" == typeof t) return I(t);
    if (null == t) return new C[N]();
    if ("string" == typeof t && "<" !== t.charAt(0))
      return I(b.document.querySelector(t));
    const n = e ? b.document.createElement("div") : S("svg");
    return (
      (n.innerHTML = t),
      (t = I(n.firstChild)),
  ...
  function D(t) {
    if (!t) return null;
    if (t.instance instanceof T) return t.instance;
    if ("#document-fragment" === t.nodeName) return new C.Fragment(t);
    let e = a(t.nodeName || "Dom");
    return (
  ...
  n("Dom", {
    ...
    insertBefore: function (t) {
      return ((t = E(t)).before(this), this);
    },
    insertAfter: function (t) {
      return ((t = E(t)).after(this), this);
    },
  });
  const Y = /^([+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?)([a-z%]*)$/i,
    B = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    H = /rgb\((\d+),(\d+),(\d+)\)/,
    V = /(#[a-z_][a-z0-9\-_]*)/i,
    $ = /\)\s*,?\s*/,
    U = /\s/g,
    W = /^#[a-f0-9]{3}$|^#[a-f0-9]{6}$/i,
    Q = /^rgb\(/,
    J = /^(\s+)?$/,
    Z = /^[+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,
    K = /\.(jpg|jpeg|png|gif|svg)(\?[^=]+.*)?/i,
    tt = /[\s,]+/,
    et = /[MLHVCSQTAZ]/i;
  var nt = {
    __proto__: null,
          ...
          if ("object" == typeof t)
            for (const e in t)
              this.node.style.setProperty(
                e,
                null == t[e] || J.test(t[e]) ? "" : t[e],
              );
        }
        return (
          2 === arguments.length &&
            this.node.style.setProperty(t, null == e || J.test(e) ? "" : e),
          this
        );
      },
      show: function () {
    ...
    n("Dom", {
      data: function (t, e, n) {
        if (null == t)
          return this.data(
            s(
              o(this.node.attributes, (t) => 0 === t.nodeName.indexOf("data-")),
  ...
  class ot {
    ...
    static isColor(t) {
      return t && (t instanceof ot || this.isRgb(t) || this.test(t));
    }
    static isRgb(t) {
      return (
        t &&
    ...
    static random(t = "vibrant", e) {
      const { random: n, round: i, sin: r, PI: s } = Math;
      if ("vibrant" === t) {
        const t = 24 * n() + 57,
          e = 38 * n() + 45,
          i = 360 * n();
        return new ot(t, e, i, "lch");
      }
      if ("sine" === t) {
        const t = i(
            80 * r((2 * s * (e = null == e ? n() : e)) / 0.5 + 0.01) + 150,
          ),
          o = i(50 * r((2 * s * e) / 0.5 + 4.6) + 200),
          h = i(100 * r((2 * s * e) / 0.5 + 2.3) + 150);
        return new ot(t, o, h);
      }
      if ("pastel" === t) {
        const t = 8 * n() + 86,
    ...
    static test(t) {
      return "string" == typeof t && (W.test(t) || Q.test(t));
    }
    cmyk() {
      const { _a: t, _b: e, _c: n } = this.rgb(),
        [i, r, s] = [t, e, n].map((t) => t / 255),
        o = Math.min(1 - i, 1 - r, 1 - s);
      if (1 === o) return new ot(0, 0, 0, 1, "cmyk");
      return new ot(
        (1 - i - o) / (1 - o),
        (1 - r - o) / (1 - o),
        (1 - s - o) / (1 - o),
    ...
    init(t = 0, e = 0, n = 0, i = 0, r = "rgb") {
        ...
        if (Q.test(t)) {
          const e = t.replace(U, ""),
            [n, i, r] = H.exec(e)
              .slice(1, 4)
              .map((t) => parseInt(t));
          Object.assign(this, { _a: n, _b: i, _c: r, _d: 0, space: "rgb" });
        } else {
          if (!W.test(t))
      ...
      const { _a: s, _b: o, _c: h, _d: u } = this,
        a =
          "rgb" === this.space
            ? { r: s, g: o, b: h }
            : "xyz" === this.space
    ...
    lab() {
      ...
      return new ot(116 * e - 16, 500 * (t - e), 200 * (e - n), "lab");
    }
    lch() {
    ...
    rgb() {
      ...
      if ("lab" === (t = this.space) || "xyz" === t || "lch" === t) {
        ...
        if ("lab" === this.space || "lch" === this.space) {
          ...
          const o = (i + 16) / 116,
            ...
            l = 0.008856,
            c = 7.787;
          ((t = 0.95047 * (h ** 3 > l ? h ** 3 : (h - a) / c)),
            (e = 1 * (o ** 3 > l ? o ** 3 : (o - a) / c)),
            (n = 1.08883 * (u ** 3 > l ? u ** 3 : (u - a) / c)));
        }
        const i = 3.2406 * t + -1.5372 * e + -0.4986 * n,
          r = -0.9689 * t + 1.8758 * e + 0.0415 * n,
          s = 0.0557 * t + -0.204 * e + 1.057 * n,
          o = Math.pow,
          h = 0.0031308,
          u = i > h ? 1.055 * o(i, 1 / 2.4) - 0.055 : 12.92 * i,
          a = r > h ? 1.055 * o(r, 1 / 2.4) - 0.055 : 12.92 * r,
          l = s > h ? 1.055 * o(s, 1 / 2.4) - 0.055 : 12.92 * s;
        return new ot(255 * u, 255 * a, 255 * l);
      }
      if ("hsl" === this.space) {
      ...
      if ("cmyk" === this.space) {
        const { c: t, m: e, y: n, k: i } = this,
          r = 255 * (1 - Math.min(1, t * (1 - i) + i)),
    ...
    toArray() {
      const { _a: t, _b: e, _c: n, _d: i, space: r } = this;
      return [t, e, n, i, r];
    }
    toHex() {
      const [t, e, n] = this._clamped().map(it);
      return `#${t}${e}${n}`;
    }
    toRgb() {
    ...
    xyz() {
      const { _a: t, _b: e, _c: n } = this.rgb(),
        ...
        h = r > 0.04045 ? Math.pow((r + 0.055) / 1.055, 2.4) : r / 12.92,
        u = s > 0.04045 ? Math.pow((s + 0.055) / 1.055, 2.4) : s / 12.92,
        a = (0.4124 * o + 0.3576 * h + 0.1805 * u) / 0.95047,
        l = (0.2126 * o + 0.7152 * h + 0.0722 * u) / 1,
        c = (0.0193 * o + 0.1192 * h + 0.9505 * u) / 1.08883,
        f = a > 0.008856 ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116,
        d = l > 0.008856 ? Math.pow(l, 1 / 3) : 7.787 * l + 16 / 116,
        m = c > 0.008856 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116;
      return new ot(f, d, m, "xyz");
    }
    _clamped() {
      const { _a: t, _b: e, _c: n } = this.rgb(),
        { max: i, min: r, round: s } = Math;
      ...
      const n = 0,
        ...
        r = Array.isArray(t)
          ...
          : "object" == typeof t
            ...
            : { x: t, y: e };
      return (
        (this.x = null == r.x ? n : r.x),
        (this.y = null == r.y ? i : r.y),
        this
      );
    }
    toArray() {
  ...
  class at {
    ...
    static formatTransforms(t) {
      const e = "both" === t.flip || !0 === t.flip,
        ...
        m = d.x,
        p = d.y,
        y = new ht(t.translate || t.tx || t.translateX, t.ty || t.translateY),
        w = y.x,
        g = y.y,
        _ = new ht(t.relative || t.rx || t.relativeX, t.ry || t.relativeY);
      return {
        scaleX: o,
        scaleY: h,
        skewX: r,
    ...
    init(t) {
      const e = at.fromArray([1, 0, 0, 1, 0, 0]);
      return (
        (t =
          t instanceof Element
            ? t.matrixify()
            : "string" == typeof t
              ? at.fromArray(t.split(tt).map(parseFloat))
              : Array.isArray(t)
                ? at.fromArray(t)
                : "object" == typeof t && at.isMatrixLike(t)
                  ? t
                  : "object" == typeof t
                    ? new at().transform(t)
                    : 6 === arguments.length
                      ? at.fromArray([].slice.call(arguments))
                      : e),
    ...
    lmultiplyO(t) {
      const e = t instanceof at ? t : new at(t);
      return at.matrixMultiply(e, this, this);
    }
    multiply(t) {
    ...
    multiplyO(t) {
      const e = t instanceof at ? t : new at(t);
      return at.matrixMultiply(this, e, this);
    }
    rotate(t, e, n) {
    ...
    scaleO(t, e = t, n = 0, i = 0) {
      ...
      const { a: r, b: s, c: o, d: h, e: u, f: a } = this;
      return (
        (this.a = r * t),
        (this.b = s * e),
        (this.c = o * t),
    ...
    shearO(t, e = 0, n = 0) {
      const { a: i, b: r, c: s, d: o, e: h, f: u } = this;
      return (
        (this.a = i + r * t),
        (this.c = s + o * t),
        (this.e = h + u * t - n * t),
    ...
    transform(t) {
      if (at.isMatrixLike(t)) {
        return new at(t).multiplyO(this);
      }
      const e = at.formatTransforms(t),
        { x: n, y: i } = new ht(e.ox, e.oy).transform(this),
        r = new at()
      ...
      if (isFinite(e.px) || isFinite(e.py)) {
        const t = new ht(n, i).transform(r),
  ...
  function lt() {
    if (!lt.nodes) {
      ...
      const e = t.path().node;
      lt.nodes = { svg: t, path: e };
    }
    if (!lt.nodes.svg.node.parentNode) {
      const t = b.document.body || b.document.documentElement;
      lt.nodes.svg.addTo(t);
    }
    return lt.nodes;
  }
  function ct(t) {
  ...
  class ft {
    ...
    addOffset() {
      return (
        (this.x += b.window.pageXOffset),
        (this.y += b.window.pageYOffset),
        new ft(this)
      );
    }
    init(t) {
    ...
    transform(t) {
      ...
      return (
        [
          new ht(this.x, this.y),
          new ht(this.x2, this.y),
          new ht(this.x, this.y2),
          new ht(this.x2, this.y2),
        ].forEach(function (s) {
          ((s = s.transform(t)),
            (e = Math.min(e, s.x)),
            (n = Math.max(n, s.x)),
    ...
    try {
      if (
        ...
        ct(i) &&
          (r = t.node) !== b.document &&
          !(
            b.document.documentElement.contains ||
            function (t) {
              for (; t.parentNode; ) t = t.parentNode;
              return t === b.document;
            }
          ).call(b.document.documentElement, r))
      )
    ...
    viewbox: {
      viewbox(t, e, n, i) {
        return null == t
          ...
          : this.attr("viewBox", new ft(t, e, n, i));
      },
      zoom(t, e) {
        let { width: n, height: i } = this.attr(["width", "height"]);
        if (
          (((n || i) && "string" != typeof n && "string" != typeof i) ||
            ((n = this.node.clientWidth), (i = this.node.clientHeight)),
          !n || !i)
        )
          throw new Error(
        ...
        (u === 1 / 0 && (u = Number.MAX_SAFE_INTEGER / 100),
          (e = e || new ht(n / 2 / s + r.x, i / 2 / o + r.y)));
        const a = new ft(r).transform(new at({ scale: u, origin: e }));
  ...
  const pt = ["toArray", "constructor", "each"];
  function yt(t, e) {
    return new mt(
      s((e || b.document).querySelectorAll(t), function (t) {
        return D(t);
      }),
    );
  }
  ...
  function _t(t) {
    ...
    return (e === b.window && (e = gt), e.events || (e.events = {}), e.events);
  }
  function xt(t) {
  ...
  function bt(t) {
    let e = t.getEventHolder();
    (e === b.window && (e = gt), e.events && (e.events = {}));
  }
  function vt(t, e, n, i, r) {
    const s = n.bind(i || t),
      ...
      h = _t(o),
      u = xt(o);
    ((e = Array.isArray(e) ? e : e.split(tt)),
      n._svgjsListenerId || (n._svgjsListenerId = ++wt),
      e.forEach(function (t) {
        const e = t.split(".")[0],
          i = t.split(".")[1] || "*";
        ((h[e] = h[e] || {}),
          (h[e][i] = h[e][i] || {}),
          (h[e][i][n._svgjsListenerId] = s),
  ...
  function Mt(t, e, n, i) {
    ...
    ("function" != typeof n || (n = n._svgjsListenerId)) &&
      (e = Array.isArray(e) ? e : (e || "").split(tt)).forEach(function (t) {
        const e = t && t.split(".")[0],
          h = t && t.split(".")[1];
        let u, a;
        if (n)
          s[e] &&
            s[e][h || "*"] &&
            (o.removeEventListener(e, s[e][h || "*"][n], i || !1),
            delete s[e][h || "*"][n]);
        else if (e && h) {
          if (s[e] && s[e][h]) {
            for (a in s[e][h]) Mt(o, [e, h].join("."), a);
            delete s[e][h];
          }
        } else if (h)
          for (t in s) for (u in s[t]) h === u && Mt(o, [t, h].join("."));
        else if (e) {
          if (s[e]) {
            for (u in s[e]) Mt(o, [e, u].join("."));
            delete s[e];
          }
        } else {
          for (t in s) Mt(o, t);
  ...
  function At(t, e, n, i) {
    const r = xt(t);
    return (
      e instanceof b.window.Event ||
        (e = new b.window.CustomEvent(e, { detail: n, cancelable: !0, ...i })),
      r.dispatchEvent(e),
      e
    );
  }
  class Ot extends T {
    ...
    dispatchEvent(t) {
      ...
      if (!e) return !0;
      const n = e[t.type];
      for (const e in n) for (const i in n[e]) n[e][i](t);
    ...
    off(t, e, n) {
      return (Mt(this, t, e, n), this);
    }
    on(t, e, n, i) {
      return (vt(this, t, e, n, i), this);
    }
    removeEventListener() {}
  }
  function kt() {}
  z(Ot, "EventTarget");
  const Tt = { duration: 400, ease: ">", delay: 0 },
    Ct = {
      "fill-opacity": 1,
      "stroke-opacity": 1,
      "stroke-width": 0,
  ...
  var Nt = { __proto__: null, attrs: Ct, noop: kt, timeline: Tt };
  class St extends Array {
    ...
    parse(t = []) {
      return t instanceof Array ? t : t.trim().split(tt).map(parseFloat);
    }
    toArray() {
      return Array.prototype.concat.apply([], this);
    }
  ...
  class Et {
    ...
    convert(t) {
      return new Et(this.value, t);
    }
    divide(t) {
      return ((t = new Et(t)), new Et(this / t, this.unit || t.unit));
    }
    init(t, e) {
      return (
  ...
  class Dom extends Ot {
    ...
    add(t, e) {
      return (
        (t = E(t)).removeNamespace &&
          this.node instanceof b.window.SVGElement &&
          t.removeNamespace(),
        null == e
    ...
    children() {
      return new mt(
        s(this.node.children, function (t) {
          return D(t);
        }),
      );
    }
    ...
    clone(t = !0, e = !0) {
      ...
      return (e && (n = q(n)), new this.constructor(n));
    }
    each(t, e) {
      const n = this.children();
      let i, r;
      for (i = 0, r = n.length; i < r; i++)
        (t.apply(n[i], [i, n]), e && n[i].each(t, e));
      return this;
    }
    element(t, e) {
      return this.put(new Dom(S(t), e));
    }
    first() {
    ...
    html(t, e) {
      return this.xml(t, e, w);
    }
    id(t) {
      return (
        void 0 !== t || this.node.id || (this.node.id = L(this.type)),
        this.attr("id", t)
      );
    }
    index(t) {
    ...
    parent(t) {
      ...
      if (((e = D(e.node.parentNode)), !t)) return e;
      do {
        if ("string" == typeof t ? e.matches(t) : e instanceof t) return e;
      } while ((e = D(e.node.parentNode)));
      return e;
    }
    put(t, e) {
    ...
    round(t = 2, e = null) {
      const n = 10 ** t,
        i = this.attr(e);
      for (const t in i)
        "number" == typeof i[t] && (i[t] = Math.round(i[t] * n) / n);
      return (this.attr(i), this);
    }
    svg(t, e) {
      return this.xml(t, e, y);
    }
    toString() {
      return this.id();
    }
    ...
    xml(t, e, n) {
      ...
      e = null != e && e;
      const i = S("wrapper", n),
        r = b.document.createDocumentFragment();
      i.innerHTML = t;
  ...
  (F(Dom, {
    attr: function (t, e, n) {
      if (null == t) {
        ...
        for (const n of e)
          t[n.nodeName] = Z.test(n.nodeValue)
        ...
        if (null == e)
          return null == (e = this.node.getAttribute(t))
            ...
            : Z.test(e)
              ? parseFloat(e)
              : e;
        ("number" == typeof (e = Dt.reduce((e, n) => n(t, e, this), e))
          ? (e = new Et(e))
          : jt.has(t) && ot.isColor(e)
            ? (e = new ot(e))
            : e.constructor === Array && (e = new St(e)),
          "leading" === t
  ...
  class Element extends Dom {
    ...
    dx(t = 0) {
      return this.x(new Et(t).plus(this.x()));
    }
    dy(t = 0) {
      return this.y(new Et(t).plus(this.y()));
    }
    getEventHolder() {
      return this;
    }
    ...
    parents(t = this.root()) {
      ...
      for (
        ...
        (i = i.parent()) &&
        i.node !== b.document &&
        "#document-fragment" !== i.nodeName &&
        (n.push(i), e || i.node !== t.node) &&
        (!e || !i.matches(t));
      )
    ...
    size(t, e) {
      const n = l(this, t, e);
      return this.width(new Et(n.width)).height(new Et(n.height));
    }
    width(t) {
      return this.attr("width", t);
    }
    writeDataToDom() {
      return (m(this, this.dom), super.writeDataToDom());
    }
    x(t) {
  ...
  (F(Element, {
    bbox: function () {
      const t = dt(
        ...
        (t) => {
          try {
            const e = t.clone().addTo(lt().svg).show(),
              n = e.node.getBBox();
            return (e.remove(), n);
          } catch (e) {
            throw new Error(
    ...
    point: function (t, e) {
      return new ht(t, e).transformO(this.screenCTM().inverseO());
    },
    ctm: function () {
      return new at(this.node.getCTM());
    },
    screenCTM: function () {
      try {
        if ("function" == typeof this.isRoot && !this.isRoot()) {
          ...
          return (t.remove(), new at(e));
        }
        return new at(this.node.getScreenCTM());
      } catch (t) {
        return (
          console.warn(
  ...
  (["fill", "stroke"].forEach(function (t) {
    ...
    ((e[t] = function (e) {
      ...
      if (
        ...
        for (i = It[t].length - 1; i >= 0; i--)
          null != e[It[t][i]] && this.attr(It.prefix(t, It[t][i]), e[It[t][i]]);
      return this;
    }),
      n(["Element", "Runner"], e));
  }),
    n(["Element", "Runner"], {
      matrix: function (t, e, n, i, r, s) {
        return null == t
          ? new at(this)
          : this.attr("transform", new at(t, e, n, i, r, s));
      },
    ...
    n("Path", {
      ...
      pointAt: function (t) {
        return new ht(this.node.getPointAtLength(t));
      },
    }),
    n(["Element", "Runner"], {
      font: function (t, e) {
  ...
  (n(
    ...
    n("Element", {
      ...
      toParent: function (t, e) {
        ...
        if (d(this.node)) return this.addTo(t, e);
      ...
      transform: function (t, e) {
        if (null == t || "string" == typeof t) {
          const e = new at(this).decompose();
          return null == t ? e : e[t];
        }
        at.isMatrixLike(t) || (t = { ...t, origin: c(t, this) });
        const n = new at(!0 === e ? this : e || !1).transform(t);
  ...
  function Xt(t) {
    return null == t ? 2 * this.rx() : this.rx(new Et(t).divide(2));
  }
  function Yt(t) {
    return null == t ? 2 * this.ry() : this.ry(new Et(t).divide(2));
  }
  z(Shape, "Shape");
  var Bt = {
    __proto__: null,
  ...
  class Ellipse extends Shape {
    ...
    size(t, e) {
      const n = l(this, t, e);
      return this.rx(new Et(n.width).divide(2)).ry(new Et(n.height).divide(2));
    }
  }
  (F(Ellipse, Bt),
    n("Container", {
    ...
    z(Ellipse, "Ellipse"));
  class Ht extends Dom {
    constructor(t = b.document.createDocumentFragment()) {
      super(t);
    }
    xml(t, e, n) {
      if (
  ...
  function Gt(t, e) {
    return "radialGradient" === (this._element || this).type
      ? this.attr({ fx: new Et(t), fy: new Et(e) })
      : this.attr({ x1: new Et(t), y1: new Et(e) });
  }
  function Vt(t, e) {
    return "radialGradient" === (this._element || this).type
      ? this.attr({ cx: new Et(t), cy: new Et(e) })
      : this.attr({ x2: new Et(t), y2: new Et(e) });
  }
  z(Ht, "Fragment");
  var $t,
    Ut = { __proto__: null, from: Gt, to: Vt };
  class Gradient extends Container {
    constructor(t, e) {
      super(j(t + "Gradient", "string" == typeof t ? null : t), e);
    }
    attr(t, e, n) {
      return (
  ...
  (($t = function (t, e, n) {
    return (
      ("fill" !== t && "stroke" !== t) ||
        (K.test(e) && (e = n.root().defs().image(e))),
      e instanceof Image &&
        (e = n
          .root()
          .defs()
  ...
  class Wt extends St {
    ...
    parse(t = [0, 0]) {
      ...
      (t =
        t instanceof Array
          ...
          : t.trim().split(tt).map(parseFloat)).length %
        2 !=
        0 && t.pop();
    ...
    transformO(t) {
      ...
      for (let e = this.length; e--; ) {
        const [n, i] = this[e];
        ((this[e][0] = t.a * n + t.c * i + t.e),
          (this[e][1] = t.b * n + t.d * i + t.f));
      }
      return this;
    }
  }
  ...
  class Line extends Shape {
    ...
    plot(t, e, n, i) {
      return null == t
        ? this.array()
        : ((t =
            void 0 !== e ? { x1: t, y1: e, x2: n, y2: i } : new Wt(t).toLine()),
          this.attr(t));
    }
    size(t, e) {
      const n = l(this, t, e);
  ...
  class te extends Kt {
    constructor(t = Tt.ease) {
      (super(), (this.ease = Zt[t] || t));
    }
    step(t, e, n) {
  ...
  F(ie, { duration: Jt("_duration", ne), overshoot: Jt("_overshoot", ne) });
  class re extends ee {
  ...
  F(re, { windup: Jt("_windup"), p: Jt("P"), i: Jt("I"), d: Jt("D") });
  const se = { M: 2, L: 2, H: 1, V: 1, C: 6, S: 4, Q: 4, T: 2, A: 7, Z: 0 },
    oe = {
      M: function (t, e, n) {
  ...
  function ue(t) {
    return (
      t.segment.length &&
      t.segment.length - 1 === se[t.segment[0].toUpperCase()]
    );
  }
  function ae(t, e) {
    t.inNumber && le(t, !1);
    ...
    ((t.inSegment = !1),
      t.absolute &&
        (t.segment = (function (t) {
          const e = t.segment[0];
          return oe[e](t.segment.slice(1), t.p, t.p0);
        })(t)),
  ...
  class pe extends St {
    bbox() {
      return (
        lt().path.setAttribute("d", this.toString()),
        new ft(lt.nodes.path.getBBox())
      );
    }
    move(t, e) {
      const n = this.bbox();
      if (((t -= n.x), (e -= n.y), !isNaN(t) && !isNaN(e)))
        for (let n, i = this.length - 1; i >= 0; i--)
          ((n = this[i][0]),
            "M" === n || "L" === n || "T" === n
                ...
                : "V" === n
                  ...
                  : "C" === n || "S" === n || "Q" === n
                    ? ((this[i][1] += t),
                      ...
                      (this[i][3] += t),
                      (this[i][4] += e),
                      "C" === n && ((this[i][5] += t), (this[i][6] += e)))
                    : "A" === n && ((this[i][6] += t), (this[i][7] += e)));
      return this;
    }
    parse(t = "M0 0") {
      return (
        ...
        (function (t, e = !0) {
          ...
          for (; (r.lastToken = i), (i = t.charAt(n++)); )
            if (r.inSegment || !ae(r, i))
              if ("." !== i)
                if (isNaN(parseInt(i)))
                  if (me.has(i)) r.inNumber && le(r, !1);
                  else if ("-" !== i && "+" !== i)
                    if ("E" !== i.toUpperCase()) {
                      if (et.test(i)) {
                        if (r.inNumber) le(r, !1);
                        else {
                          if (!ue(r)) throw new Error("parser Error");
                          ce(r);
                        }
                        --n;
                      }
                  ...
                  if ("0" === r.number || fe(r)) {
                    ((r.inNumber = !0), (r.number = i), le(r, !0));
                    continue;
                  }
    ...
    size(t, e) {
      ...
      for (
        ...
        ((r = this[i][0]),
          "M" === r || "L" === r || "T" === r
            ? ((this[i][1] = ((this[i][1] - n.x) * t) / n.width + n.x),
              (this[i][2] = ((this[i][2] - n.y) * e) / n.height + n.y))
            : "H" === r
              ? (this[i][1] = ((this[i][1] - n.x) * t) / n.width + n.x)
              : "V" === r
                ? (this[i][1] = ((this[i][1] - n.y) * e) / n.height + n.y)
                : "C" === r || "S" === r || "Q" === r
                  ? ((this[i][1] = ((this[i][1] - n.x) * t) / n.width + n.x),
                    (this[i][2] = ((this[i][2] - n.y) * e) / n.height + n.y),
                    (this[i][3] = ((this[i][3] - n.x) * t) / n.width + n.x),
                    (this[i][4] = ((this[i][4] - n.y) * e) / n.height + n.y),
                    "C" === r &&
                      ((this[i][5] = ((this[i][5] - n.x) * t) / n.width + n.x),
                      (this[i][6] = ((this[i][6] - n.y) * e) / n.height + n.y)))
                  : "A" === r &&
                    ((this[i][1] = (this[i][1] * t) / n.width),
                    (this[i][2] = (this[i][2] * e) / n.height),
                    (this[i][6] = ((this[i][6] - n.x) * t) / n.width + n.x),
                    (this[i][7] = ((this[i][7] - n.y) * e) / n.height + n.y)));
      return this;
    }
    toString() {
      return (function (t) {
  ...
  class _e {
    ...
    init(t) {
      return (
        ...
        Object.assign(this, _e.defaults, t),
        this
      );
    }
    toArray() {
  ...
  const xe = (t, e) => (t[0] < e[0] ? -1 : t[0] > e[0] ? 1 : 0);
  class be {
    constructor(...t) {
      this.init(...t);
    }
    align(t) {
      ...
      for (let n = 0, i = e.length; n < i; ++n) {
        if (e[n + 1] === t[n + 1]) {
          if (e[n + 1] === ot && t[n + 7] !== e[n + 7]) {
            const e = t[n + 7],
              i = new ot(this.values.splice(n + 3, 5))[e]().toArray();
  ...
  function Ae() {
    F(ve, {
      to(t) {
        return new we().type(this.constructor).from(this.toArray()).to(t);
      },
      fromArray(t) {
  ...
  class Path extends Shape {
    ...
    array() {
      return this._array || (this._array = new pe(this.attr("d")));
    }
    clear() {
    ...
    plot(t) {
      return null == t
        ...
        : this.clear().attr(
            "d",
            "string" == typeof t ? t : (this._array = new pe(t)),
          );
    }
    size(t, e) {
      const n = l(this, t, e);
  ...
  ((Path.prototype.MorphArray = pe),
    n({
      Container: {
        path: X(function (t) {
          return this.put(new Path()).plot(t || new pe());
        }),
      },
    }),
    z(Path, "Path"));
  var Oe = {
    ...
    plot: function (t) {
      return null == t
        ...
        : this.clear().attr(
            "points",
            "string" == typeof t ? t : (this._array = new Wt(t)),
          );
    },
    size: function (t, e) {
      const n = l(this, t, e);
  ...
  (n({
    Container: {
      polygon: X(function (t) {
        return this.put(new Polygon()).plot(t || new Wt());
      }),
    },
  }),
    F(Polygon, Qt),
  ...
  (n({
    Container: {
      polyline: X(function (t) {
        return this.put(new Polyline()).plot(t || new Wt());
      }),
    },
  }),
    F(Polyline, Qt),
  ...
  const Te = {
      ...
      timeouts: new ke(),
      immediates: new ke(),
      timer: () => b.window.performance || b.window.Date,
      transforms: [],
      frame(t) {
        const e = Te.frames.push({ run: t });
        return (
          null === Te.nextDraw &&
            (Te.nextDraw = b.window.requestAnimationFrame(Te._draw)),
          e
        );
      },
      timeout(t, e) {
        e = e || 0;
        const n = Te.timer().now() + e,
          i = Te.timeouts.push({ run: t, time: n });
        return (
          null === Te.nextDraw &&
            (Te.nextDraw = b.window.requestAnimationFrame(Te._draw)),
          i
      ...
      cancelFrame(t) {
        null != t && Te.frames.remove(t);
      },
      clearTimeout(t) {
        null != t && Te.timeouts.remove(t);
      },
      cancelImmediate(t) {
        null != t && Te.immediates.remove(t);
      },
      _draw(t) {
        let e = null;
        const n = Te.timeouts.last();
        for (
          ;
          (e = Te.timeouts.shift()) &&
          (t >= e.time ? e.run() : Te.timeouts.push(e), e !== n);
        );
        let i = null;
        const r = Te.frames.last();
        for (; i !== r && (i = Te.frames.shift()); ) i.run(t);
        let s = null;
        for (; (s = Te.immediates.shift()); ) s();
        Te.nextDraw =
          Te.timeouts.first() || Te.frames.first()
            ? b.window.requestAnimationFrame(Te._draw)
            : null;
      },
    },
    Ce = function (t) {
  ...
  class Se extends Ot {
    ...
    schedule(t, e, n) {
      if (null == t) return this._runners.map(Ce);
      let i = 0;
    ...
    _continue(t = !1) {
      return (
        ...
        t
          ? this._stepImmediate()
          : (this._paused || (this._nextFrame = Te.frame(this._step)), this)
      );
    }
    _stepFn(t = !1) {
      ...
      ((this._lastSourceTime = e),
        t ||
          ((this._time += i), (this._time = this._time < 0 ? 0 : this._time)),
      ...
      for (let t = 0, e = this._runners.length; t < e; t++) {
        ...
        if (s.step(o).done) {
          if (!0 !== n.persist) {
            s.duration() - s.time() + this._time + n.persist < this._time &&
              (s.unschedule(), --t, --e);
          }
        } else r = !0;
      }
      return (
        (r && !(this._speed < 0 && 0 === this._time)) ||
  ...
  n({
    Element: {
      timeline: function (t) {
        return null == t
          ? ((this._timeline = this._timeline || new Se()), this._timeline)
  ...
  class Ee extends Ot {
    constructor(t) {
      (super(),
        (this.id = Ee.id++),
        (t =
          "function" == typeof (t = null == t ? Tt.duration : t)
            ? new ee(t)
            : t),
        (this._element = null),
        (this._timeline = null),
        ...
        (this._isDeclarative = t instanceof ee),
        (this._stepper = this._isDeclarative ? t : new te()),
        (this._history = {}),
        (this.enabled = !0),
        (this._time = 0),
        (this._lastTime = 0),
        (this._reseted = !0),
        (this.transforms = new at()),
        (this.transformId = 1),
    ...
    animate(t, e, n) {
      const i = Ee.sanitise(t, e, n),
        r = new Ee(i.duration);
      return (
        this._timeline && r.timeline(this._timeline),
        this._element && r.element(this._element),
        r.loop(i).schedule(i.delay, i.when)
      );
    }
    clearTransform() {
      return ((this.transforms = new at()), this);
    }
    ...
    ease(t) {
      return ((this._stepper = new te(t)), this);
    }
    element(t) {
      return null == t
        ? this._element
    ...
    loop(t, e, n) {
      return (
        "object" == typeof t && ((e = t.swing), (n = t.wait), (t = t.times)),
        (this._times = t || 1 / 0),
        (this._swing = e || !1),
        (this._wait = n || 0),
    ...
    schedule(t, e, n) {
      if ((t instanceof Se || ((n = e), (e = t), (t = this.timeline())), !t))
    ...
    _initialise(t) {
      if (t || this._isDeclarative)
        for (let e = 0, n = this._queue.length; e < n; ++e) {
          ...
          ((t = !n.finished),
            i && t && (n.initialiser.call(this), (n.initialised = !0)));
        }
    }
  ...
  F([Ee, je], {
    mergeWith(t) {
      return new je(t.transforms.lmultiply(this.transforms), t.id);
    },
  });
  const De = (t, e) => t.lmultiplyO(e),
    Ie = (t) => t.transforms;
  function ze() {
    const t = this._transformationRunners.runners.map(Ie).reduce(De, new at());
    (this.transform(t),
    ...
    Element: {
      ...
      _addRunner(t) {
        (this._transformationRunners.add(t),
          Te.cancelImmediate(this._frameId),
          (this._frameId = Te.immediate(ze.bind(this))));
      },
      _prepareRunner() {
        null == this._frameId &&
          (this._transformationRunners = new Pe().add(new je(new at(this))));
      },
    },
  });
  (F(Ee, {
    ...
    styleAttr(t, e, n) {
      ...
      let r = new we(this._stepper).to(i),
        s = Object.keys(i);
      return (
        this.queue(
          function () {
          ...
          function (e) {
            ...
            if (o.length) {
              const e = this.element()[t](o),
                n = new be(r.from()).valueOf();
              (Object.assign(n, e), r.from(n));
            }
            const u = new be(r.to()).valueOf();
            (Object.assign(u, e), r.to(u), (s = n), (i = e));
          },
        ),
        this._rememberMorpher(t, r),
        this
      );
    },
    zoom(t, e) {
      if (this._tryRetarget("zoom", t, e)) return this;
      let n = new we(this._stepper).to(new Et(t));
      return (
        this.queue(
          function () {
    ...
    transform(t, e, n) {
      if (
        ...
        return this;
      const i = at.isMatrixLike(t);
      n = null != t.affine ? t.affine : null != n ? n : !i;
      const r = new we(this._stepper).type(n ? _e : at);
      let s, o, h, u, a;
      return (
        this.queue(
          function () {
          ...
          function (l) {
            ...
            const { x: c, y: f } = new ht(s).transform(
              o._currentTransform(this),
            );
            let d = new at({ ...t, origin: [c, f] }),
            ...
            (e &&
              (i || (d.rotate = t.rotate || 0),
              this._isDeclarative && u && (m.rotate = u)),
              r.from(m),
              r.to(d));
            const p = r.at(l);
            return (
          ...
          function (e) {
            ((e.origin || "center").toString() !==
              (t.origin || "center").toString() && (s = c(e, o)),
              (t = { ...e, origin: s }));
          },
          !0,
        ),
        this._isDeclarative && this._rememberMorpher("transform", r),
        this
      );
    },
    x(t) {
    ...
    _queueNumberDelta(t, e) {
      if (((e = new Et(e)), this._tryRetarget(t, e))) return this;
      const n = new we(this._stepper).to(e);
      let i = null;
      return (
        this.queue(
          function () {
    ...
    _queueNumber(t, e) {
      return this._queueObject(t, new Et(e));
    },
    cx(t) {
    ...
    plot(t, e, n, i) {
      ...
      const r = new we(this._stepper).type(this._element.MorphArray).to(t);
      return (
        this.queue(
          function () {
    ...
    viewbox(t, e, n, i) {
      return this._queueObject("viewbox", new ft(t, e, n, i));
    },
    update(t) {
    ...
    F(Ee, { rx: zt, ry: Pt, from: Gt, to: Vt }),
    z(Ee, "Runner"));
  class Svg extends Container {
    ...
    defs() {
      return this.isRoot()
        ? D(this.node.querySelector("defs")) || this.put(new Defs())
        : this.root().defs();
    }
    isRoot() {
      return (
        !this.node.parentNode ||
        (!(this.node.parentNode instanceof b.window.SVGElement) &&
          "#document-fragment" !== this.node.parentNode.nodeName)
      );
    }
    namespace() {
      return this.isRoot()
        ? this.attr({ xmlns: y, version: "1.1" }).attr("xmlns:xlink", _, g)
        : this.root().namespace();
    }
    removeNamespace() {
      return this.attr({ xmlns: null, version: null })
        .attr("xmlns:xlink", null, g)
        .attr("xmlns:svgjs", null, g);
    }
    root() {
  ...
  var Re = {
    ...
    plain: function (t) {
      return (
        ...
        this.node.appendChild(b.document.createTextNode(t)),
        this
      );
    },
  ...
  class Text extends Shape {
    constructor(t, e = t) {
      (super(j("text", t), e),
        (this.dom.leading = this.dom.leading ?? new Et(1.3)),
        (this._rebuild = !0),
        (this._build = !1));
    }
    leading(t) {
      return null == t
        ? this.dom.leading
        : ((this.dom.leading = new Et(t)), this.rebuild());
    }
    rebuild(t) {
    ...
    setData(t) {
      return (
        (this.dom = t),
        (this.dom.leading = new Et(t.leading || 1.3)),
        this
      );
    }
    writeDataToDom() {
      return (m(this, this.dom, { leading: 1.3 }), this);
    }
    text(t) {
      if (void 0 === t) {
        ...
        for (let i = 0, r = e.length; i < r; ++i)
          "textPath" === e[i].nodeName || d(e[i])
            ? 0 === i && (n = i + 1)
            : (i !== n &&
                3 !== e[i].nodeType &&
                !0 === D(e[i]).dom.newLined &&
                (t += "\n"),
              (t += e[i].textContent));
        return t;
      }
  ...
  class Tspan extends Shape {
    ...
    newLine() {
      ...
      const e = t.index(this),
        n = b.window.getComputedStyle(this.node).getPropertyValue("font-size"),
        i = t.dom.leading * new Et(n);
  ...
  class Circle extends Shape {
    ...
    size(t) {
      return this.radius(new Et(t).divide(2));
    }
  }
  (F(Circle, { x: Rt, y: Lt, cx: qt, cy: Ft, width: Xt, height: Yt }),
    n({
      Container: {
  ...
  class ClipPath extends Container {
    ...
    targets() {
      return yt("svg [clip-path*=" + this.id() + "]");
    }
  }
  (n({
    Container: {
  ...
  (n({
    Container: {
      foreignObject: X(function (t, e) {
        return this.put(new Le()).size(t, e);
      }),
    },
  }),
    z(Le, "ForeignObject"));
  var qe = {
    ...
    dmove: function (t, e) {
      return (
        this.children().forEach((n) => {
          ...
          const r = new at(n),
            s = r.translate(t, e).transform(r.inverse()),
            o = new ht(i.x, i.y).transform(s);
          n.move(o.x, o.y);
        }),
        this
      );
    ...
    size: function (t, e, n = this.bbox()) {
      const i = l(this, t, e, n),
        r = i.width / n.width,
        s = i.height / n.height;
      return (
        this.children().forEach((t) => {
          const e = new ht(n).transform(new at(t).inverse());
          t.scale(r, s, e.x, e.y);
        }),
        this
      );
  ...
  class Stop extends Element {
    ...
    update(t) {
      return (
        ("number" == typeof t || t instanceof Et) &&
          (t = {
            offset: arguments[0],
            color: arguments[1],
            opacity: arguments[2],
        ...
        null != t.opacity && this.attr("stop-opacity", t.opacity),
        null != t.color && this.attr("stop-color", t.color),
        null != t.offset && this.attr("offset", new Et(t.offset)),
        this
      );
    }
  }
  ...
  (n({
    ...
    Path: {
      ...
      targets() {
        return yt("svg textPath").filter((t) =>
          (t.attr("href") || "").includes(this.id()),
        );
      },
    },
  }),
    (TextPath.prototype.MorphArray = pe),
    z(TextPath, "TextPath"));
  ...
  (n({
    ...
    z(Use, "Use"));
  const Fe = E;
  (F([Svg, Symbol, Image, Pattern, Marker], i("viewbox")),
    F([Line, Polyline, Polygon, Path], i("marker")),
    F(Text, i("Text")),
    F(Path, i("Path")),
    F(Defs, i("Defs")),
    F([Text, Tspan], i("Tspan")),
    F([Rect, Ellipse, Gradient, Ee], i("radius")),
    F(Ot, i("EventTarget")),
    F(Dom, i("Dom")),
    F(Element, i("Element")),
    F(Shape, i("Shape")),
    F([Container, Ht], i("Container")),
    F(Gradient, i("Gradient")),
    F(Ee, i("Runner")),
    mt.extend([...new Set(e)]),
    Me([Et, ot, ft, at, St, Wt, pe, ht]),
    Ae());
  var Xe = {
    __proto__: null,
    A: A,
    ...
    withWindow: function (t, e) {
      (O(), v(t, t.document), e(t, t.document), k());
    },
    wrapWithAttrCheck: X,
  };
  function Ye(t, e) {
